...
public class Test {
	...
	public static void main(String[] args) throws UsuarioRepetidoException {
		...
		*/
		//el factory devuelve un vehiculo del arraylist de vehiculos no crea un vehiculo dependiendo de la capacidad 
		//contemplar cuando el factory puede ser null por la cantidad de pasajeros o se pide un "helicoptero"
		...
		c1.SolicitaViaje(new Pedido("Estandar",true,true,"02/01/2020 13:12",2));//con mascota
		c1.SolicitaViaje(new Pedido("Calle sin asfaltar",false,true,"02/01/2020 13:13",7));//con equipaje
		c1.SolicitaViaje(new Pedido("Zona Peligrosa",false,false,"02/01/2020 13:14",3));
		//que tendriamos que contemplar en solicitud incoerente??? por que los datos se pasan por constructor o no?
